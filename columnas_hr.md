...
* BusinessTravel: Frecuencia de viajes laborales (por ejemplo, Travel\_Rarely, Travel\_Frequently).
...
* EmployeeCount: Valor constante (normalmente 1), que indica un empleado por registro.
...
* NumCompaniesWorked: Número de empresas en las que ha trabajado previamente.Over18: Indica si el empleado es mayor de 18 años.
